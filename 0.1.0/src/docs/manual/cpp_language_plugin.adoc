...
NOTE: This plugin provides the {cpp} implementation language capability to a project already providing a runtime and/or entry point, such as the <<jni_library_plugin.adoc#,JNI Library Plugin>>.
