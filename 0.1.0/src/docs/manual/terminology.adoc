...
For example, the <<jni_library_plugin.adoc#,JNI Library Plugin>> provides the library entry point capability to the project it is applied.
...
For example, the <<jni_library_plugin.adoc#,JNI Library Plugin>> provides the JNI runtime capability to the project it is applied.
