...
You can also apply one of <<plugin_references.adoc#,Nokee plugins>> by link:{gradle-user-manual}/plugins.html#sec:plugins_block[pecifying the version inside the plugins block] as shown in the following example.
