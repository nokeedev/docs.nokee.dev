...
:jbake-permalink: jni-library-composing
:jbake-archivebasename: JniLibraryComposing
:includedir: /Users/daniel/gradle/gradle-native/subprojects/docs/src/docs/samples/jni-library-composing
= Compose a JNI Library
:jbake-summary: Compose JNI library from other projects.
...
Root project 'jni-library-composing' - The JNI library as the consumer would expect.
...
[source,groovy]
----
include::{includedir}/groovy-dsl/cpp-greeter/build.gradle[]
----
=====
[.multi-language-sample]
=====
...
[source,kotlin]
----
include::{includedir}/kotlin-dsl/cpp-greeter/build.gradle.kts[]
----
=====
====
...
[source,groovy]
----
include::{includedir}/groovy-dsl/java-jni-greeter/build.gradle[]
----
=====
[.multi-language-sample]
=====
...
[source,kotlin]
----
include::{includedir}/kotlin-dsl/java-jni-greeter/build.gradle.kts[]
----
=====
====
...
The <<../../manual/jni_library_plugin.adoc#,JNI Library Plugin>> will automatically generate the JNI headers and wire them properly to the native compilation task when both JNI binding project is inside the same project.
...
[source,groovy]
----
include::{includedir}/groovy-dsl/cpp-jni-greeter/build.gradle[]
----
=====
[.multi-language-sample]
=====
...
[source,kotlin]
----
include::{includedir}/kotlin-dsl/cpp-jni-greeter/build.gradle.kts[]
----
=====
====
...
[source,groovy]
----
include::{includedir}/groovy-dsl/java-loader/build.gradle[]
----
=====
[.multi-language-sample]
=====
...
[source,kotlin]
----
include::{includedir}/kotlin-dsl/java-loader/build.gradle.kts[]
----
=====
====
...
----
$ jar tf ./build/libs/jni-library-composing.jar
META-INF/
...
--------------------------------------------------
Capabilities
    - :jni-library-composing:unspecified (default capability)
Attributes
...
Artifacts
    - build/libs/jni-library-composing.jar (artifactType = jar)
