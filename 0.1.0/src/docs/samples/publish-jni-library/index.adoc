...
:includedir: /Users/daniel/gradle/gradle-native/subprojects/docs/src/docs/samples/publish-jni-library
...
If you are looking at publishing a JNI library with multiple target machines, see link:../publishing-jni-library-with-target-machines/[this other sample].
...
For more information, see <<../../manual/jni_library_plugin.adoc#,JNI Library Plugin>> and link:{gradle-user-manual}/publishing_maven.html[Maven Publish Plugin] reference chapters.
