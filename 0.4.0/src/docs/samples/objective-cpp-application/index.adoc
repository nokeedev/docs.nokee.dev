...
:jbake-permalink: objective-cpp-application
:jbake-archivebasename: ObjectiveCppApplication
:includedir: .
= Objective-{cpp} Application
:jbake-summary: Application implemented in Objective-{cpp}.
:jbake-type: sample_chapter
:jbake-tags: sample, application, objective-cpp, native, gradle
:jbake-category: Native Development
:jbake-description: See how the Nokee Gradle plugins are used for building a native application implemented in Objective-{cpp}.
...
[listing.terminal]
----
$ ./build/exes/main/objective-cpp-application
Bonjour, Alice!
----
